...
RUN apt-get install -y curl build-essential ruby ruby-dev patch zlib1g-dev liblzma-dev libpq-dev libfreetype6 libfreetype-dev libfreetype6-dev libfreetype
