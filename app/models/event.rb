class Event < ApplicationRecord
    ...
    def screenshot
        begin
            ...
            command="google-chrome --headless --enable-logging --virtual-time-budget=10000 --disable-gpu --no-sandbox --screenshot=\"#{Rails.root.join('public')}/#{uuid}.png\" \"https://tubatuba.net/event/#{@self.id}\""
            puts command
            system(command)
